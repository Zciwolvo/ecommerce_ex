...
const BagSummary = (props) => {
  return (
    <>
      <LoginContainer>
        <Row>
          <BigText>Podsumowanie koszyka</BigText>
        ...
        <Divider />
        <Row style={{ marginTop: "5%", width: "98%" }}>
        ...
        >
          <LoginButton>
            <ButtonText>Przejdź do płatności</ButtonText>
          </LoginButton>
        </Column>
        <Row style={{ justifyContent: "center" }}>
          <Text style={{ margin: "1em 0 1em 0", padding: "0" }}>
            <Link style={{ textDecoration: "none", color: "black" }} to={{}}>
              <b>Kontynuuj zakupy</b>
            </Link>
          </Text>
        </Row>
      </LoginContainer>
